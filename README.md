...
~~~sh
# getting the code
git clone git@github.com:nko4/nkzawa.git && cd ./nkzawa/

# developing
npm install
npm start

# deploying (to http://nkzawa.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@nkzawa.2013.nodeknockout.com
ssh root@nkzawa.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@nkzawa.2013.nodeknockout.com
ssh -i ./id_deploy root@nkzawa.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/nkzawa" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
